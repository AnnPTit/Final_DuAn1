...
//    }
    public KhachHang update(KhachHang khachHang) {
        ...
        try ( Session session = HibernateConfig.getFACTORY().openSession()) {
            ...
            query.setParameter("name", khachHang.getName());
            query.setParameter("sex", khachHang.getSex());
            query.setParameter("address", khachHang.getAddress());
            query.setParameter("phone", khachHang.getPhone());
            query.setParameter("email", khachHang.getEmail());
            query.setParameter("status", khachHang.getStatus());
            query.setParameter("code", khachHang.getCode());
            check = query.executeUpdate();
            transision.commit();
        } catch (Exception e) {
